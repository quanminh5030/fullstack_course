describe('Blog app', function () {
  beforeEach(function () {
    ...
    cy.createUser({
      name: 'Quan Dao', username: 'quanminh5030', password: 'mypassword'
    })
  ...
  describe('when logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('#url').type('https://dmitripavlutin.com/interface-vs-implementation/')
      cy.get('#create-button').click()

      cy.get('.blog')
        .should('have.length', 1)
        .and('contain', 'Programming to Interface Vs to Implementation Dmitri Pavlutin')
    })
  })
  ...
  describe('blog functionalities', () => {
    ...
    it('user who was not created a blog cannot delete it', function () {
      cy.createUser({
        name: 'Test User', username: 'test', password: 'mypassword'
      })
