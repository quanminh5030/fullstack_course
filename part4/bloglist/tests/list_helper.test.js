...
describe('favorite blog', () => {
  ...
  test('return blog with most liked', () => {
    const mostLikesBlog = {
      _id: "5a422b3a1b54a676234d17f9",
      title: "Canonical string reduction",
      author: "Edsger W. Dijkstra",
...
describe('most likes', () => {
  ...
  test('return author whose blog posts have most likes', () => {

    const authorWithMostLikesBlogs = {
      author: "Edsger W. Dijkstra",
      likes: 17
    };
    ...
    expect(result).toEqual(authorWithMostLikesBlogs);
  });
